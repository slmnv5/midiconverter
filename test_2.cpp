...
TEST_CASE("Test RuleMapper 1", "[all]")
{
	...
	r1.parseString("n,,,=n,2,122,122=p; note rule 2");
	r1.parseString("c,,,=n,2,122,122 =p; note rule 2");
	...
	SECTION("Section to string 1")
	{
		...
		REQUIRE(s1 == "n,0:15,0:127,0:127=n,2:2,122:122,122:122=p");
		string s2 = r1.getRule(2).toString();
		REQUIRE(s2 == "c,0:15,0:127,0:127=n,2:2,122:122,122:122=p");
